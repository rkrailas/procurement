                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <input class="form-control form-control-sm" type="text" maxlength="250" required
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <x-select2 id="purchase_unit-select2" required='true'
                        ...
                        <div class="col-md-4">
                            ...
                            <input class="form-control form-control-sm" type="number" step="0.01" required
