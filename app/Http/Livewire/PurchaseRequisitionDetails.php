...
class PurchaseRequisitionDetails extends Component
{
    ...
    //Authorization
        public function updatedValidatorUsername()
        {
            ...
            WHERE username='" . $this->validator['username'] . "'";
            $data = DB::select($strsql);
            if ($data) {
            ...
            if ($this->prItem){
                if ($this->prHeader['ordertype'] == '11' OR $this->prHeader['ordertype'] == '21'){
                    ...
                    foreach ($xInternal_order_dd as $row) {
                        ...
                        $newOption = $newOption . ">" . $row['internal_order'] . " - " . $row['description'] . "</option>";
                    }
    ...
    public function editPR()
    {
        ...
        $strsql = "SELECT prh.id, prh.prno, ort.description AS ordertypename
                ...
                , delivery_location.site + ' : ' + delivery_location.delivery_location AS delivery_location_desc
                ...
                LEFT JOIN (SELECT site, address_id, site_description, delivery_location FROM site WHERE SUBSTRING(address_id, 7, 2)='EN') delivery_location ON delivery_location.site=prh.delivery_address
